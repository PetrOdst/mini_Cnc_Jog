...
#define KEYSTROKE_DELAY 10
#define KEY_FOR_XY01_1 KEY_LEFT_CTRL
#define KEY_FOR_XY01_2 'a'
#define KEY_FOR_XY01_3

#define KEY_FOR_XY1_1
#define KEY_FOR_XY1_2
#define KEY_FOR_XY1_3

#define KEY_FOR_XY10_1
#define KEY_FOR_XY10_2
#define KEY_FOR_XY10_3

#define KEY_FOR_XY100_1
#define KEY_FOR_XY100_2
#define KEY_FOR_XY100_3

#define KEY_FOR_Z01_1
#define KEY_FOR_Z01_2
#define KEY_FOR_Z01_3

#define KEY_FOR_Z1_1
#define KEY_FOR_Z1_2
#define KEY_FOR_Z1_3

#define KEY_FOR_Z10_1
#define KEY_FOR_Z10_2
#define KEY_FOR_Z10_3
...
// Setup OneButton lib rotary encoder button pins. / Nastavení pinů tlačítek rotačních enkodérů pro knihovnu OneButton 
...
void xy01(){
  ...
  Keyboard.begin();
  Keyboard.press(KEY_FOR_XY01_1);
  Keyboard.press(KEY_FOR_XY01_2);
  Keyboard.press(KEY_FOR_XY01_3);  
...
void xy1(){
  Keyboard.begin();
  Keyboard.press(KEY_FOR_XY1_1);
  Keyboard.press(KEY_FOR_XY1_2);
  Keyboard.press(KEY_FOR_XY1_3);  
  delay(KEYSTROKE_DELAY);
  Keyboard.releaseAll();  
}
void xy10(){
  Keyboard.begin();
  Keyboard.press(KEY_FOR_XY10_1);
  Keyboard.press(KEY_FOR_XY10_2);
  Keyboard.press(KEY_FOR_XY10_3);  
  delay(KEYSTROKE_DELAY);
  Keyboard.releaseAll();
...
void xy100(){
  Keyboard.begin();
  Keyboard.press(KEY_FOR_XY100_1);
  Keyboard.press(KEY_FOR_XY100_2);
  Keyboard.press(KEY_FOR_XY100_3);  
  delay(KEYSTROKE_DELAY);
  Keyboard.releaseAll();
}
